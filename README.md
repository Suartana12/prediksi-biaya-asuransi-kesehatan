...
[1](https://www.researchgate.net/profile/Munashe-Naphtali-Mupa/publication/389132064_Machine_Learning_in_Actuarial_Science_Enhancing_Predictive_Models_for_Insurance_Risk_Management/links/67b60a83645ef274a4897f9a/Machine-Learning-in-Actuarial-Science-Enhancing-Predictive-Models-for-Insurance-Risk-Management.pdf) Griffin, G., & Linskens, E. (2018). Predictive Modeling and Risk Adjustment in Health Insurance. Society of Actuaries.
[2](https://www.atsjournals.org/doi/full/10.1513/AnnalsATS.201710-787OC) Morid, M. A., Abdelrahman, O., & Farhood, P. (2021). A Comparison of Machine Learning Algorithms for Predicting Readmission to the ICU and Medical Costs. Journal of Medical Internet Research, 23(7), e15432.
